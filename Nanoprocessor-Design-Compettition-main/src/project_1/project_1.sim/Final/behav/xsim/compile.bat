...
REM
REM Generated by Vivado on Fri May 01 22:17:37 +0530 2026
...
echo "xvhdl --incr --relax -prj TB_Tri_State_Buffer_vhdl.prj"
call xvhdl  --incr --relax -prj TB_Tri_State_Buffer_vhdl.prj -log xvhdl.log
