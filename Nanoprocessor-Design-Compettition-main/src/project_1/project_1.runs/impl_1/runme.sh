...
HD_PWD='C:/Users/VICTUS/OneDrive/Desktop/COADD/Nanoprocessor-Design/Nanoprocessor-Design-Compettition-main/src/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Tri_State_Buffer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Tri_State_Buffer.tcl -notrace
