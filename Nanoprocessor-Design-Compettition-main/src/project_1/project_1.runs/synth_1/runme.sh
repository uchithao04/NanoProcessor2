...
HD_PWD='C:/Users/VICTUS/OneDrive/Desktop/COADD/Nanoprocessor-Design/Nanoprocessor-Design-Compettition-main/src/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Tri_State_Buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Tri_State_Buffer.tcl
